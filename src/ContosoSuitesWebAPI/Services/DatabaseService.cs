...
public class DatabaseService : IDatabaseService
{
    ...
    [KernelFunction]
    [Description("Retrieves all bookings for a given hotel.")]
    public async Task<IEnumerable<Booking>> GetBookingsForHotel([Description("The ID for the hotel")] int hotelId)
    {
    ...
    [KernelFunction]
    [Description("Retrieves all bookings for a given hotel after a minimum date.")]
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate([Description("The ID for the hotel")] int hotelId, [Description("Search start date")] DateTime dt)
    {
    ...
    [KernelFunction]
    [Description("Retrieves all bookings that are missing hotel rooms.")]
    ...
    [KernelFunction]
    [Description("Retrieves all bookings that have multiple hotel rooms.")]
